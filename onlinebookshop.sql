...
add constraint FK_custName
	FOREIGN KEY(custName) REFERENCES customerInfo(custName)*/
...
------------用户基本表测试用例
insert into customerInfo(custName,pwd,email) values ('小红','123456','766528@qq.com')
insert into customerInfo(custName,pwd,email) values ('小橙','123456','asdasd@163.com')
insert into customerInfo(custName,pwd,email) values ('小黄','123456','akksd@yahu.com')
insert into customerInfo(custName,pwd,email) values ('小绿','123456','aaaaaa@qq.com')
insert into customerInfo(custName,pwd,email) values ('小蓝','123456','qqqqqq@qq.com')
select * from customerInfo

------------用户详细信息表测试用例
insert into customerDetailInfo(custId,tel,address,sex,age,countMoney,qq) values(1,'13545698425','玉祥门','0',21,125.6,'766528')
insert into customerDetailInfo(custId,tel,address,sex,age,countMoney,qq) values(2,'15885695429','明德门','0',18,5.6,'8885328')
insert into customerDetailInfo(custId,tel,address,sex,age,countMoney,qq) values(3,'15845698425','长安路','0',22,1225.6,'766528')
insert into customerDetailInfo(custId,tel,address,sex,age,countMoney,qq) values(4,'15999668489','大雁塔','0',23,25.6,'766528')
insert into customerDetailInfo(custId,tel,address,sex,age,countMoney,qq) values(5,'13645655423','马路','0',20,null,'766528')
...
--emp表数据测试
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('超哥',22,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('哈哈',2,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('嘟嘟',22,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('么么',22,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('呜呜',23,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('嘿嘿',22,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('帅哥',20,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('妹纸',21,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('十大',22,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('暗暗地',26,'1999-9-9',1,1)
insert into employee(empName, empAge,empBtd,empSex, isDelete)values('孙孙',23,'1999-9-9',1,1)
select* from employee

--新闻表数据测试
insert into news (newsTitle,content,newsBtd)
 values ('sdadsdads','sdsdsdsdsd','2015-07-22')
insert into news (newsTitle,content,newsBtd)
 values ('qqqqqqqq','qqwwwwwwww','2015-07-22')
insert into news (newsTitle,content,newsBtd)
 values ('rrrrrrrrrrr','rrr','2015-07-22')
insert into news (newsTitle,content,newsBtd)
 values ('tttttttt','ww','2015-07-22')
insert into news (newsTitle,content,newsBtd)
 values ('ssss','qqqqq','2015-07-22')
