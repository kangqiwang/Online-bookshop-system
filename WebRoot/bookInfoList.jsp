...
<div class="middle">
    ...
    <div class="middle_right">
      ...
      <div class="middle_right6con">
             <div class="warpbor">
                <div class="leftshop"><a href="#"><img src="images/pic8.jpg" /></a></div>
                <div class="righttext"><h3>目送：龙应台</h3><p> 
       				 <span class="fontcc">(50629条评论)</span><br />
         龙应台 著/2009-09-01<br />
        /生活.读书.新知三联书店 龙应台的文字，「横眉冷对千夫指」时，寒气逼人，如刀光剑影。「俯首甘为孺子牛」时，却温柔婉转彷佛微风吹过麦田。从纯真喜悦的《孩子你慢慢来》到坦率得近乎「痛楚」的《亲爱的安德烈》，龙应台的写作境界逐渐转往人生的深沉。　　《目送》的七十四篇散文，写父亲的逝、母亲的老、儿子的离、朋友的牵挂、兄弟的携手共行，写失败和脆弱、失落和放手，写缠绵不舍和绝然的虚无。她写尽了幽微，如烛光冷照山
     			   <span class="xiangx">  29.20 <span class="textde"> 39.00</span> 折扣：75折 <a href="#"><img src="images/btn_buy.gif"></a><a href="collect.html"><img src="images/btn_keep.gif"></a></span></div>
            </div>
            <div class="warpbor">
                <div class="leftshop"><a href="#"><img src="images/pic8.jpg" /></a></div>
                <div class="righttext"><h3>目送：龙应台</h3><p> 
  	...
  	<div class="scott"><span class="disabled"> 上一页 </span><span class="thisclass">1</span><a href="#?page=2">2</a><a href="#?page=3">3</a><a href="#?page=4">4</a><a href="#?page=5">5</a><a href="#?page=6">6</a><a href="#?page=7">7</a>...<a href="#?page=199">199</a><a href="#?page=200">200</a><a href="#?page=2"> 下一页 </a></div>
