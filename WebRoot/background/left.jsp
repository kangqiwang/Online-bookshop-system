...
<%@page import="com.jzyqd.entity.SysAdmin"%>
...
%>
  <tr>
    <td colspan="2" align="center">欢迎您:<%=sysAdmin.getAdminName() %></td>
  </tr>
 
 <%if(sysAdmin.getAdminType() == 3) {%>
	<%@include file="sysAdminLeft.jsp" %> 
 ...
 <%}%>
  ...
  <tr>
    <td background="images/ht08.jpg" class="wr4"> 
      <div align="center">
      <a href="<%=request.getContextPath()%>/BackgroundLoginOutServlet"
      target="_parent">退 出 系 统</a>
