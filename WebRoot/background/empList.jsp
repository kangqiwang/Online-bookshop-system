    	...
    	<table border="1">
    		...
    		<c:forEach var="emp" items="${requestScope.emps}">
    			<tr onmouseover="this.bgColor='red'" onmouseout="this.bgColor='white'">
    				...
    				<td>${emp.empSex}</td>
    				<td>${emp.empAge}</td>
    				<td><a href="${pageContext.request.contextPath}/FindByEmployeeIdServlet?id=${emp.empId}">update</a></td>
    				<td><a href="${pageContext.request.contextPath}/DeleteEmployeeServlet?id=${emp.empId}"
