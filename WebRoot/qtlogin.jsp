...
<script type="text/javascript">
  ...
  <div class="t_Top">
	  ...
	  <form id="login" name="login" method="post" action="<%=request.getContextPath()%>/QTLoginServlet" onkeydown="onkey(this,event);">
				...
				<div class="n_dl_c_l_b">
				  ...
				  <table width="262" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <input type="submit" name="Submit" value="登 录" class="button_26" tabindex="5" /></td>
                    </tr>
                    <tr>
